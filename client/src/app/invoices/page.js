...
export default function InvoicesPage() {
  return (
    <main className="flex-1 p-container-margin md:p-container-margin overflow-x-hidden">
      {/* Breadcrumbs */}
      <nav className="flex items-center gap-2 font-label-md text-label-md text-tertiary mb-stack-lg">
        ...
        <Link className="hover:text-primary transition-colors" href="/clients/1">
          Acme Corp
        </Link>
        <span className="material-symbols-outlined text-[16px]">
          chevron_right
      ...
      <section className="bg-surface-container-lowest rounded-xl border border-outline-variant p-card-padding mb-stack-lg shadow-[0_2px_4px_rgba(0,0,0,0.05)] relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-stack-lg relative z-10">
          ...
          <div className="flex gap-stack-md w-full md:w-auto mt-4 md:mt-0">
            <a
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-surface-container-lowest border border-on-surface text-on-surface font-label-md text-label-md hover:bg-surface-container-low transition-colors shadow-sm"
              href="#"
            >
      ...
      {/* Workspace Tabs */}
      <div className="border-b border-outline-variant mb-stack-lg">
        <nav className="flex gap-stack-lg font-label-md text-label-md">
          <Link
            className="pb-3 text-tertiary hover:text-on-surface transition-colors"
            href="/clients/1"
          >
            Overview
          </Link>
          ...
          <Link
            className="pb-3 text-primary border-b-2 border-primary font-bold"
            href="/invoices"
          >
            Invoices
          </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter mb-stack-lg">
        <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-4 shadow-[0_2px_4px_rgba(0,0,0,0.05)]">
          <h3 className="font-label-sm text-label-sm text-tertiary uppercase mb-2">
            Total Billed YTD
          </h3>
        ...
        <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-4 shadow-[0_2px_4px_rgba(0,0,0,0.05)] border-l-4 border-l-error">
          <h3 className="font-label-sm text-label-sm text-error uppercase mb-2 font-bold">
            Overdue
          </h3>
          <div className="flex items-end justify-between">
      ...
      <div className="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-[0_2px_4px_rgba(0,0,0,0.05)] overflow-hidden">
        <div className="p-4 border-b border-outline-variant flex justify-between items-center bg-[#FAFAFA]">
          ...
          <div className="flex items-center gap-2">
            <button
              className="p-2 rounded-md hover:bg-surface-container-high transition-colors text-tertiary"
              title="Filter"
            >
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#FAFAFA] border-b border-outline-variant">
                <th className="py-3 px-4 font-label-sm text-label-sm text-tertiary uppercase tracking-wider">
                  Invoice #
                </th>
                <th className="py-3 px-4 font-label-sm text-label-sm text-tertiary uppercase tracking-wider">
                  Date
                ...
                <th className="py-3 px-4 font-label-sm text-label-sm text-tertiary uppercase tracking-wider text-right">
                  Amount
                </th>
                <th className="py-3 px-4 font-label-sm text-label-sm text-tertiary uppercase tracking-wider text-right">
                  GST (10%)
            ...
            <tbody className="font-body-sm text-body-sm">
              ...
              <tr className="border-b border-[#F0F0F0] hover:bg-[#F9F9F9] transition-colors group">
                ...
                <td className="py-4 px-4 text-error font-medium">
                  Oct 15, 2023
                </td>
                ...
                <td className="py-4 px-4">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-xl font-label-sm text-label-sm bg-error/10 text-error border border-error/20">
                    Overdue
                  </span>
                </td>
                <td className="py-4 px-4 text-right">
                  <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      className="p-1.5 rounded text-tertiary hover:text-primary hover:bg-primary/10 transition-colors"
                      title="Send Reminder"
                    >
                      <span className="material-symbols-outlined text-[18px]">
                        send
                    ...
                    <button
                      className="p-1.5 rounded text-tertiary hover:text-on-surface hover:bg-surface-container-high transition-colors"
                      title="Download PDF"
                    >
                      <span className="material-symbols-outlined text-[18px]">
                        download
              ...
              <tr className="border-b border-[#F0F0F0] hover:bg-[#F9F9F9] transition-colors group">
                ...
                <td className="py-4 px-4">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-xl font-label-sm text-label-sm bg-orange-100 text-orange-800 border border-orange-200">
                    Pending
                  </span>
                </td>
                <td className="py-4 px-4 text-right">
              ...
              <tr className="border-b border-[#F0F0F0] hover:bg-[#F9F9F9] transition-colors group">
                ...
                <td className="py-4 px-4">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-xl font-label-sm text-label-sm bg-green-100 text-green-800 border border-green-200">
                    Paid
                  </span>
                </td>
                <td className="py-4 px-4 text-right">
        ...
        <div className="p-4 border-t border-outline-variant flex items-center justify-between bg-surface-container-lowest">
          <span className="font-body-sm text-body-sm text-tertiary">
            Showing 4 of 24 invoices
          </span>
          <div className="flex items-center gap-2">
            <button className="px-3 py-1 rounded border border-outline-variant text-tertiary font-label-sm text-label-sm cursor-not-allowed opacity-50">
              Previous
            </button>
            <button className="px-3 py-1 rounded border border-outline-variant text-on-surface hover:bg-surface-container-low transition-colors font-label-sm text-label-sm">
              Next
            </button>
          </div>
        </div>
