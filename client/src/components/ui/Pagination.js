...
// Generic server-side pagination bar — same shape as the bespoke
// ClientsPagination/LeadsPagination/TeamPagination components elsewhere in
// the app, pulled out so new paginated lists (Agreements, Misc Tasks, ...)
// don't need another copy of this.
export default function Pagination({ page, limit, totalItems, totalPages, loading, onPageChange }) {
