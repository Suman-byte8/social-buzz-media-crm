        ...
        <main className="flex-1 overflow-y-auto p-container-margin">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-stack-lg gap-4">
                <div>
                    ...
                    <p className="font-body-md text-body-md text-on-surface-variant mt-1">Review and manage monthly performance reports for all active campaigns.</p>
                </div>
                {/* Filter & Action */}
            ...
            {/* Reports Grid (Bento/Card Style) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-gutter">
                {/* Card 1 */}
                <div className="bg-surface rounded-xl border border-outline-variant p-card-padding shadow-sm hover:shadow-md transition-shadow flex flex-col group relative overflow-hidden">
                    ...
                    <h3 className="font-title-lg text-title-lg text-on-background mb-1">October 2023</h3>
                    <p className="font-body-sm text-body-sm text-on-surface-variant mb-stack-lg flex-1">Acme Corp - Q4 Campaign Performance Review.</p>
                ...
                <div className="bg-surface rounded-xl border border-outline-variant p-card-padding shadow-sm hover:shadow-md transition-shadow flex flex-col group relative overflow-hidden">
                    ...
                    <h3 className="font-title-lg text-title-lg text-on-background mb-1">September 2023</h3>
                    <p className="font-body-sm text-body-sm text-on-surface-variant mb-stack-lg flex-1">TechStart - Monthly SEO &amp; Traffic Growth Analysis.</p>
                    <div className="flex items-center gap-stack-sm pt-stack-md border-t border-outline-variant mt-auto">
                        <button className="flex-1 bg-surface border border-outline-variant text-on-surface font-label-md text-label-md py-2 rounded-lg hover:bg-surface-variant transition-colors flex justify-center items-center gap-2">
                            <span className="material-symbols-outlined text-[18px]">download</span>
                            PDF
                ...
                <div className="bg-surface rounded-xl border border-outline-variant p-card-padding shadow-sm hover:shadow-md transition-shadow flex flex-col group relative overflow-hidden">
                    ...
                    <h3 className="font-title-lg text-title-lg text-on-background mb-1">August 2023</h3>
                    <p className="font-body-sm text-body-sm text-on-surface-variant mb-stack-lg flex-1">Globex - End of Summer Sale Meta Ads Recap.</p>
                    <div className="flex items-center gap-stack-sm pt-stack-md border-t border-outline-variant mt-auto">
                        <button className="flex-1 bg-surface border border-outline-variant text-on-surface font-label-md text-label-md py-2 rounded-lg hover:bg-surface-variant transition-colors flex justify-center items-center gap-2">
                            <span className="material-symbols-outlined text-[18px]">download</span>
                            PDF
                ...
                {/* Card 4 (Draft State) */}
                <div className="bg-surface rounded-xl border-2 border-dashed border-outline-variant p-card-padding hover:border-primary/50 transition-colors flex flex-col items-center justify-center text-center opacity-70 hover:opacity-100 min-h-[240px] cursor-pointer group">
                    ...
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Compile data for November 2023</p>
                </div>
            </div>
        </main>
    );
